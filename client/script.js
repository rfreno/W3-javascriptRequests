...
const repeatMyParam = () => {
    axios.get(`http://localhost:3000/repeat/confused`)
        .then((res) => {
...
const queryFunc = () => {
    axios.get('http://localhost:3000/query-test/?question=myQuestion')
        .then((res) => {
...
/*
    ...
    1: Send no queries on the URL -- it says ' You sent an empty query!'

    2: Send more than 1 query on the URL -- it says 'You sent more than 1 query!'
*/
